/**
 * Build script for @mixpeek/anthropic
 */
...
console.log('Building @mixpeek/anthropic...');
...
module.exports = {
  async createToolDefinitions(config) { const mod = await getModule(); return new mod.ToolDefinitions(config); },
  getModule,
  version: '1.0.0'
};
`;
...
const dtsContent = `/**
 * @mixpeek/anthropic — TypeScript declarations
 */
...
export declare class ContentAdapter {
  constructor(config: ConnectorConfig);
  adaptContent(...args: any[]): any;
  adaptImage(...args: any[]): any;
  adaptDocument(...args: any[]): any;
  formatResults(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}
...
export declare function createToolDefinitions(config: ConnectorConfig): ToolDefinitions;
export declare function createContentAdapter(config: ConnectorConfig): ContentAdapter;
export declare function createMcpServer(config: ConnectorConfig): McpServer;
