/**
 * Build script for @mixpeek/aws-s3
 */
...
console.log('Building @mixpeek/aws-s3...');
...
module.exports = {
  async createS3Watcher(config) { const mod = await getModule(); return new mod.S3Watcher(config); },
  getModule,
  version: '1.0.0'
};
`;
...
const dtsContent = `/**
 * @mixpeek/aws-s3 — TypeScript declarations
 */
...
export declare class S3Watcher {
  constructor(config: ConnectorConfig);
  watch(...args: any[]): any;
  stop(...args: any[]): any;
  onObject(...args: any[]): any;
  processEvent(...args: any[]): any;
  getWatchedBuckets(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}

export declare class S3Enricher {
  constructor(config: ConnectorConfig);
  enrich(...args: any[]): any;
  enrichBatch(...args: any[]): any;
  getEnrichment(...args: any[]): any;
  setOutputBucket(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}

export declare class S3EventParser {
  constructor(config: ConnectorConfig);
  parse(...args: any[]): any;
  parseRecord(...args: any[]): any;
  isSupported(...args: any[]): any;
  getObjectKey(...args: any[]): any;
  getBucketName(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}

export declare function createS3Watcher(config: ConnectorConfig): S3Watcher;
export declare function createS3Enricher(config: ConnectorConfig): S3Enricher;
export declare function createS3EventParser(config: ConnectorConfig): S3EventParser;
