/**
 * Build script for @mixpeek/azure-blob
 */
...
console.log('Building @mixpeek/azure-blob...');
...
module.exports = {
  async createBlobWatcher(config) { const mod = await getModule(); return new mod.BlobWatcher(config); },
  getModule,
  version: '1.0.0'
};
`;
...
const dtsContent = `/**
 * @mixpeek/azure-blob — TypeScript declarations
 */
...
export declare class BlobWatcher {
  constructor(config: ConnectorConfig);
  watch(...args: any[]): any;
  stop(...args: any[]): any;
  onBlob(...args: any[]): any;
  processEvent(...args: any[]): any;
  getWatchedContainers(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}

export declare class BlobEnricher {
  constructor(config: ConnectorConfig);
  enrich(...args: any[]): any;
  enrichBatch(...args: any[]): any;
  getEnrichment(...args: any[]): any;
  setOutputContainer(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}

export declare class EventGridParser {
  constructor(config: ConnectorConfig);
  parse(...args: any[]): any;
  parseRecord(...args: any[]): any;
  isSupported(...args: any[]): any;
  getBlobName(...args: any[]): any;
  getContainerName(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}

export declare function createBlobWatcher(config: ConnectorConfig): BlobWatcher;
export declare function createBlobEnricher(config: ConnectorConfig): BlobEnricher;
export declare function createEventGridParser(config: ConnectorConfig): EventGridParser;
