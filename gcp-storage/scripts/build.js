...
console.log('Building @mixpeek/gcs...');
...
module.exports = {
  async createGCSWatcher(config) { const mod = await getModule(); return new mod.GCSWatcher(config); },
  getModule,
  version: '1.0.0'
};
`;
...
const dtsContent = `/**
 * @mixpeek/gcs — TypeScript declarations
 */
...
export declare class GCSWatcher {
  constructor(config: ConnectorConfig);
  watch(...args: any[]): any;
  stop(...args: any[]): any;
  onObject(...args: any[]): any;
  processNotification(...args: any[]): any;
...
export declare class GCSEnricher {
  constructor(config: ConnectorConfig);
  enrich(...args: any[]): any;
...
export declare class GCSEventParser {
  constructor(config: ConnectorConfig);
  parse(...args: any[]): any;
...
export declare function createGCSWatcher(config: ConnectorConfig): GCSWatcher;
export declare function createGCSEnricher(config: ConnectorConfig): GCSEnricher;
export declare function createGCSEventParser(config: ConnectorConfig): GCSEventParser;
