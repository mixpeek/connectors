/**
 * Build script for @mixpeek/langchain
 */
...
console.log('Building @mixpeek/langchain...');
...
module.exports = {
  async createMixpeekRetriever(config) { const mod = await getModule(); return new mod.MixpeekRetriever(config); },
  getModule,
  version: '1.0.0'
};
`;
...
const dtsContent = `/**
 * @mixpeek/langchain — TypeScript declarations
 */
...
export declare class MixpeekRetriever {
  ...
  getRelevantDocuments(...args: any[]): any;
  invoke(...args: any[]): any;
...
export declare class MixpeekTool {
  constructor(config: ConnectorConfig);
  call(...args: any[]): any;
  invoke(...args: any[]): any;
...
export declare class MixpeekDocumentLoader {
  constructor(config: ConnectorConfig);
  load(...args: any[]): any;
  loadAndSplit(...args: any[]): any;
...
export declare function createMixpeekTool(config: ConnectorConfig): MixpeekTool;
export declare function createMixpeekDocumentLoader(config: ConnectorConfig): MixpeekDocumentLoader;
