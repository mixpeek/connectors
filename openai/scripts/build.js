/**
 * Build script for @mixpeek/openai
 */
...
console.log('Building @mixpeek/openai...');
...
module.exports = {
  async createEmbeddingBridge(config) { const mod = await getModule(); return new mod.EmbeddingBridge(config); },
  getModule,
  version: '1.0.0'
};
`;
...
const dtsContent = `/**
 * @mixpeek/openai — TypeScript declarations
 */
...
export declare class EmbeddingBridge {
  constructor(config: ConnectorConfig);
  embed(...args: any[]): any;
  embedBatch(...args: any[]): any;
  store(...args: any[]): any;
  search(...args: any[]): any;
...
export declare class FunctionCallingAdapter {
  constructor(config: ConnectorConfig);
  getTools(...args: any[]): any;
  handleToolCall(...args: any[]): any;
  getSchemas(...args: any[]): any;
...
export declare class AssistantTool {
  constructor(config: ConnectorConfig);
  createTool(...args: any[]): any;
  handleRun(...args: any[]): any;
  getToolOutput(...args: any[]): any;
...
export declare function createEmbeddingBridge(config: ConnectorConfig): EmbeddingBridge;
export declare function createFunctionCallingAdapter(config: ConnectorConfig): FunctionCallingAdapter;
export declare function createAssistantTool(config: ConnectorConfig): AssistantTool;
