/**
 * Build script for @mixpeek/pagerduty
 */
...
console.log('Building @mixpeek/pagerduty...');
...
module.exports = {
  async createAlertManager(config) { const mod = await getModule(); return new mod.AlertManager(config); },
  getModule,
  version: '1.0.0'
};
`;
...
const dtsContent = `/**
 * @mixpeek/pagerduty — TypeScript declarations
 */
...
export declare class AlertManager {
  ...
  acknowledge(...args: any[]): any;
  resolve(...args: any[]): any;
  getOpenAlerts(...args: any[]): any;
  setRoutingKey(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}

export declare class IncidentFormatter {
  constructor(config: ConnectorConfig);
  formatIncident(...args: any[]): any;
  formatChange(...args: any[]): any;
  addCustomDetails(...args: any[]): any;
  setSeverity(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}
...
export declare function createAlertManager(config: ConnectorConfig): AlertManager;
export declare function createIncidentFormatter(config: ConnectorConfig): IncidentFormatter;
export declare function createHealthChecker(config: ConnectorConfig): HealthChecker;
