/**
 * Build script for @mixpeek/sanity
 */
...
console.log('Building @mixpeek/sanity...');
...
const dtsContent = `/**
 * @mixpeek/sanity — TypeScript declarations
 */
...
export declare class WebhookHandler {
  ...
  parsePayload(...args: any[]): any;
  filterDocuments(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}

export declare class DocumentEnricher {
  constructor(config: ConnectorConfig);
  enrichDocument(...args: any[]): any;
  enrichImage(...args: any[]): any;
  enrichBatch(...args: any[]): any;
  getEnrichment(...args: any[]): any;
  patchDocument(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}
...
export declare function createDocumentEnricher(config: ConnectorConfig): DocumentEnricher;
export declare function createSanityClient(config: ConnectorConfig): SanityClient;
