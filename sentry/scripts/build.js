/**
 * Build script for @mixpeek/sentry
 */
...
console.log('Building @mixpeek/sentry...');
...
module.exports = {
  async createErrorReporter(config) { const mod = await getModule(); return new mod.ErrorReporter(config); },
  getModule,
  version: '1.0.0'
};
`;
...
const dtsContent = `/**
 * @mixpeek/sentry — TypeScript declarations
 */
...
export declare class PerformanceMonitor {
  constructor(config: ConnectorConfig);
  startTransaction(...args: any[]): any;
  startSpan(...args: any[]): any;
  finishTransaction(...args: any[]): any;
  setMeasurement(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}

export declare class MixpeekIntegration {
  constructor(config: ConnectorConfig);
  setupOnce(...args: any[]): any;
...
export declare function createErrorReporter(config: ConnectorConfig): ErrorReporter;
export declare function createPerformanceMonitor(config: ConnectorConfig): PerformanceMonitor;
export declare function createMixpeekIntegration(config: ConnectorConfig): MixpeekIntegration;
