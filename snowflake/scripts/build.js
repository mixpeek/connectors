/**
 * Build script for @mixpeek/snowflake
 */
...
console.log('Building @mixpeek/snowflake...');
...
module.exports = {
  async createSnowflakeClient(config) { const mod = await getModule(); return new mod.SnowflakeClient(config); },
  getModule,
  version: '1.0.0'
};
`;
...
const dtsContent = `/**
 * @mixpeek/snowflake — TypeScript declarations
 */
...
export declare class SnowflakeClient {
...
export declare class ExternalFunction {
  constructor(config: ConnectorConfig);
  handler(...args: any[]): any;
  validate(...args: any[]): any;
  formatResponse(...args: any[]): any;
...
export declare function createSnowflakeClient(config: ConnectorConfig): SnowflakeClient;
export declare function createExternalFunction(config: ConnectorConfig): ExternalFunction;
export declare function createStreamProcessor(config: ConnectorConfig): StreamProcessor;
