/**
 * Build script for @mixpeek/strapi
 */
...
console.log('Building @mixpeek/strapi...');
...
module.exports = {
  async createStrapiLifecycle(config) { const mod = await getModule(); return new mod.StrapiLifecycle(config); },
  getModule,
  version: '1.0.0'
};
`;
...
const dtsContent = `/**
 * @mixpeek/strapi — TypeScript declarations
 */
...
export declare class StrapiLifecycle {
...
export declare function createStrapiLifecycle(config: ConnectorConfig): StrapiLifecycle;
export declare function createContentEnricher(config: ConnectorConfig): ContentEnricher;
export declare function createPluginConfig(config: ConnectorConfig): PluginConfig;
