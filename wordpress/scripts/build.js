/**
 * Build script for @mixpeek/wordpress
 */
...
console.log('Building @mixpeek/wordpress...');
...
module.exports = {
  async createRestApiHandler(config) { const mod = await getModule(); return new mod.RestApiHandler(config); },
  getModule,
  version: '1.0.0'
};
`;
...
const dtsContent = `/**
 * @mixpeek/wordpress — TypeScript declarations
 */
...
export declare class RestApiHandler {
  ...
  verifyNonce(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}

export declare class PostEnricher {
  constructor(config: ConnectorConfig);
  enrichPost(...args: any[]): any;
  enrichPage(...args: any[]): any;
  enrichBatch(...args: any[]): any;
  getEnrichment(...args: any[]): any;
  setCustomField(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}
...
export declare class HookManager {
  ...
  removeAction(...args: any[]): any;
  addFilter(...args: any[]): any;
  removeFilter(...args: any[]): any;
  getRegistered(...args: any[]): any;
  getMetrics(): MetricsResult;
  resetMetrics(): void;
  destroy(): void;
}

export declare function createRestApiHandler(config: ConnectorConfig): RestApiHandler;
export declare function createPostEnricher(config: ConnectorConfig): PostEnricher;
export declare function createHookManager(config: ConnectorConfig): HookManager;
